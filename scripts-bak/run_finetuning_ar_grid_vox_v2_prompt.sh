...
# ##### v9_ns_50 #####
CUDA_VISIBLE_DEVICES=1  python trainer/finetuning_ar_grid_vox_v2_prompt.py  --exp-mode="finetuning"  --max-permit-vertices=6500 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=6500 --max-faces=3000 --batch-size=1  --check-step=200 --exp-flag="grid_vocab_n6_ft_fr_shpnet" --num-classes=120 --nn-vertices-predict-ratio=1.0  --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_grid_vocab_grid_vocab_n6_shpnet_indi_False_ctx_550_gs_2_ngrids_800_scale_0_ShapeNetCore.v2_bsz_1_max_verts_6500_max_permit_verts_6500_key_256/vertex_model/122000.pth"  --not-remove-du=True --max-num-grids=800 --grid-size=2  --quantization-bits=6  --load-meta=True  --prefix-key-len=256 --prefix-value-len=256 --num-parts=1  --context-window=700  --sampling-max-num-grids=1600  --balance-classes=True  --learning-rate=5e-5 --use-context-window-as-max=True   # --adaptation-optimization #  --use-inst=True  #  --category-part-indicator=True # --debug=True   # --debug=True # --context-window=400 --use-inst=True # --ar-object=True --half-part --use-context-window-as-max=True  

# --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_grid_vocab_grid_vocab_n6_partnet_indi_False_ctx_600_gs_2_ngrids_800_scale_0_PartNet_voxelized_64_bsz_1_max_verts_6500_max_permit_verts_6500_key_256/vertex_model/202000.pth" 
