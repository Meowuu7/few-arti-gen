...
# grid size; quantization bits...
##### grid, context window, gridsize ##### # MotionDataset_processed_voxelized_64_v9_ns_50 --> processed voxelized
...
# # ##### v9_ns_50 #####
# CUDA_VISIBLE_DEVICES=1,3 TORCH_DISTRIBUTED_DEBUG=INFO python -m torch.distributed.launch --nproc_per_node=2  \
# trainer/pretraining_ar_grid_vox_v2_ddp.py  --exp-mode="pretraining"  --max-permit-vertices=3000 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=3000 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="grid_vocab_n3_obj_val" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=2  --quantization-bits=6  --load-meta=True  --prefix-key-len=256 --prefix-value-len=256 --num-parts=2  --context-window=800 --use-context-window-as-max=True   --sampling-max-num-grids=1600 --ar-object=True --balance-classes=True  #  --use-inst=True  #  --category-part-indicator=True # --debug=True   # --debug=True # --context-window=400 --use-inst=True
...
# ##### PartNet #####
CUDA_VISIBLE_DEVICES=0,3,4,5,6,7 TORCH_DISTRIBUTED_DEBUG=INFO python -m torch.distributed.launch --nproc_per_node=6  \
trainer/pretraining_ar_grid_vox_v2_ddp.py  --exp-mode="pretraining"  --max-permit-vertices=6500 --max-permit-faces=3000 --dataset-name=${DATASET_NAME} --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=6500 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="gv_n5_motion_p3" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=2  --quantization-bits=6  --load-meta=True  --prefix-key-len=256 --prefix-value-len=256 --num-parts=2  --context-window=600 --use-context-window-as-max=True   --sampling-max-num-grids=1600 --ar-object=True --balance-classes=True --num-objects=3 --use-part --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_grid_vocab_gv_n5_motion_p3_indi_False_ctx_600_gs_2_ngrids_800_nobj_3_scale_0_MotionDataset_processed_voxelized_64_ns_50_bsz_1_max_verts_6500_max_permit_verts_6500_key_256/vertex_model/232000.pth"  #  --use-inst=True  #  --category-part-indicator=True # --debug=True   # --debug=True # --context-window=400 --use-inst=True


# # ##### PartNet #####
# CUDA_VISIBLE_DEVICES=2,3,4,5,6,7 TORCH_DISTRIBUTED_DEBUG=INFO python -m torch.distributed.launch --nproc_per_node=6  \
# trainer/pretraining_ar_grid_vox_v2_ddp.py  --exp-mode="pretraining"  --max-permit-vertices=6500 --max-permit-faces=3000 --dataset-name="PartNet_voxelized_64" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=6500 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="grid_vocab_n6_partnet" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=2  --quantization-bits=6  --load-meta=True  --prefix-key-len=256 --prefix-value-len=256 --num-parts=2  --context-window=600 --use-context-window-as-max=True   --sampling-max-num-grids=1600 --ar-object=True --balance-classes=True  #  --use-inst=True  #  --category-part-indicator=True # --debug=True   # --debug=True # --context-window=400 --use-inst=True


# # ##### ShapeNet #####
# CUDA_VISIBLE_DEVICES=1 TORCH_DISTRIBUTED_DEBUG=INFO python -m torch.distributed.launch --nproc_per_node=1  \
# trainer/pretraining_ar_grid_vox_v2_ddp.py  --exp-mode="pretraining"  --max-permit-vertices=6500 --max-permit-faces=3000 --dataset-name="ShapeNetCore.v2" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=6500 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="grid_vocab_n6_shpnet" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=2  --quantization-bits=6  --load-meta=True  --prefix-key-len=256 --prefix-value-len=256 --num-parts=2  --context-window=600 --use-context-window-as-max=True   --sampling-max-num-grids=1600 --ar-object=True --balance-classes=True  #  --use-inst=True  #  --category-part-indicator=True # --debug=True   # --debug=True # --context-window=400 --use-inst=True


# # ##### ShapeNet #####
# CUDA_VISIBLE_DEVICES=2,3,4,5,6,7  TORCH_DISTRIBUTED_DEBUG=INFO python -m torch.distributed.launch --nproc_per_node=6  \
# trainer/pretraining_ar_grid_vox_v2_ddp.py  --exp-mode="pretraining"  --max-permit-vertices=6500 --max-permit-faces=3000 --dataset-name="ShapeNetCore.v2" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=6500 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="grid_vocab_n6_shpnet" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=2  --quantization-bits=6  --load-meta=True  --prefix-key-len=256 --prefix-value-len=256 --num-parts=2  --context-window=550 --use-context-window-as-max=True   --sampling-max-num-grids=1600 --ar-object=True --balance-classes=True  #  --use-inst=True  #  --category-part-indicator=True # --debug=True   # --debug=True # --context-window=400 --use-inst=True



# grid size; quantization bits...
# ##### grid, context window, gridsize #####
# CUDA_VISIBLE_DEVICES=0,3 TORCH_DISTRIBUTED_DEBUG=INFO python -m torch.distributed.launch --nproc_per_node=2 \
# trainer/pretraining_ar_grid_vox_v2.py  --exp-mode="pretraining"  --max-permit-vertices=6500 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=6500 --max-faces=3000 --batch-size=1  --check-step=200 --exp-flag="grid_obj_corpus" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=2  --quantization-bits=6  --category-part-indicator=True --load-meta=True  --prefix-key-len=256 --prefix-value-len=256 --num-parts=3  --context-window=600 --use-context-window-as-max=True  --sampling-max-num-grids=800 --balance-classes=True # --use-inst=True #  --category-part-indicator=True # --debug=True   # --debug=True # --context-window=400



# ##### v9_ns_50 #####
# CUDA_VISIBLE_DEVICES=2,3,4,5,6,7 TORCH_DISTRIBUTED_DEBUG=INFO python -m torch.distributed.launch --nproc_per_node=6  \
# trainer/pretraining_ar_grid_vox_v2_ddp.py  --exp-mode="pretraining"  --max-permit-vertices=6500 --max-permit-faces=6500 --dataset-name="MotionDataset_processed_voxelized_64_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=3000 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="grid_vocab_n3_obj_val" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=650 --grid-size=2  --quantization-bits=6  --load-meta=True  --prefix-key-len=256 --prefix-value-len=256 --num-parts=2  --context-window=600 --use-context-window-as-max=True   --sampling-max-num-grids=1600 --ar-object=True --balance-classes=True  #  --use-inst=True  #  --category-part-indicator=True # --debug=True   # --debug=True # --context-window=400 --use-inst=True


# grid size; quantization bits...
# ##### grid, context window, gridsize #####
# CUDA_VISIBLE_DEVICES=0,1,3 TORCH_DISTRIBUTED_DEBUG=INFO python -m torch.distributed.launch --nproc_per_node=3  \
# trainer/pretraining_ar_grid_vox_v2.py  --exp-mode="pretraining"  --max-permit-vertices=6500 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=6500 --max-faces=3000 --batch-size=1  --check-step=200 --exp-flag="grid_obj_corpus_n3" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=2  --quantization-bits=6  --category-part-indicator=True --load-meta=True  --prefix-key-len=256 --prefix-value-len=256 --num-parts=3  --context-window=450 --use-context-window-as-max=True  --sampling-max-num-grids=800 --balance-classes=True # --use-inst=True #  --category-part-indicator=True # --debug=True   # --debug=True # --context-window=400

##### 

# --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_grid_vocab_grid_vox_vocab_n3_indi_True_ctx_-1_gs_2_ngrids_700_scale_0_MotionDataset_processed_voxelized_64_v9_ns_50_bsz_1_max_verts_6400_max_permit_verts_6400_key_256/vertex_model/46400.pth"  
