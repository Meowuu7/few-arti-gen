...
#### vox prompt ####
# grid size; quantization bits...
### MotionDataset_processed_voxelized_64_v9_ns_50
### MotionDataset_processed_voxelized_64
# CUDA_VISIBLE_DEVICES=5 python trainer/pretraining_ar_vox_prompt.py  --exp-mode="pretraining"  --max-permit-vertices=900 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_v9_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=900 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="parts_v9" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=900 --grid-size=1  --quantization-bits=6  --category-part-indicator=True --context-window=400  --prefix-key-len=32 --prefix-value-len=32 --load-meta=True  # --debug=True   # --debug=True #  --apply-random-scaling=1 --apply-random-scaling=1 

# CUDA_VISIBLE_DEVICES=5 python trainer/pretraining_ar_vox_prompt.py  --exp-mode="pretraining"  --max-permit-vertices=1000 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_v9_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=1000 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="parts_all" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=1000 --grid-size=1  --quantization-bits=6  --category-part-indicator=True --context-window=400  --prefix-key-len=32 --prefix-value-len=32 --load-meta=True # --debug=True   # --debug=True #  --apply-random-scaling=1 --apply-random-scaling=1 

# CUDA_VISIBLE_DEVICES=5 python trainer/pretraining_ar_vox_prompt.py  --exp-mode="pretraining"  --max-permit-vertices=1100 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_32_v9_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=1100 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="parts_v9" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=1100 --grid-size=1  --quantization-bits=5  --category-part-indicator=True --context-window=400  --prefix-key-len=32 --prefix-value-len=32 --load-meta=True # --debug=True   # --debug=True #  --apply-random-scaling=1 --apply-random-scaling=1 

# CUDA_VISIBLE_DEVICES=1 python trainer/pretraining_ar_vox_prompt.py  --exp-mode="pretraining"  --max-permit-vertices=800 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=800 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="parts_all" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=1  --quantization-bits=6  --category-part-indicator=True --context-window=400  --prefix-key-len=512 --prefix-value-len=512 --load-meta=True # --debug=True   # --debug=True #  --apply-random-scaling=1 --apply-random-scaling=1 


#### part collection v9 ####
# CUDA_VISIBLE_DEVICES=4,5,6,7 TORCH_DISTRIBUTED_DEBUG=INFO python -m torch.distributed.launch --nproc_per_node=4  \
# trainer/pretraining_ar_vox_prompt_ddp.py  --exp-mode="pretraining"  --max-permit-vertices=800 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_v9_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=800 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="parts_v9_4n" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=1  --quantization-bits=6  --category-part-indicator=True  --prefix-key-len=512 --prefix-value-len=512 --load-meta=True --context-window=400   # --use-inst=True  -context-window=400 --debug=True   # --debug=True #  --apply-random-scaling=1 --apply-random-scaling=1  --context-window=400 


#### train the model without class conditional ####
#### ['globe', 'valve', 'handcart', 'screwdriver', 'window', 'swiss_army_knife', 'kettle', 'wine_bottle', 'cabinet', 'bucket']
CUDA_VISIBLE_DEVICES=2,3,4,5,6,7 TORCH_DISTRIBUTED_DEBUG=INFO python -m torch.distributed.launch --nproc_per_node=6  \
trainer/pretraining_ar_vox_prompt_ddp.py  --exp-mode="pretraining"  --max-permit-vertices=650 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=650 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="parts_v9_6n" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=650 --grid-size=1  --quantization-bits=6  --prefix-key-len=512 --prefix-value-len=512 --load-meta=True --context-window=300  --balance-classes=True #  --category-part-indicator=True   --use-inst=True  -context-window=400 --debug=True   # --debug=True #  --apply-random-scaling=1 --apply-random-scaling=1  --context-window=400  # --balance-classes=True

# CUDA_VISIBLE_DEVICES=3 python trainer/pretraining_ar_vox_prompt.py  --exp-mode="pretraining"  --max-permit-vertices=900 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_32_v9_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=900 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="parts_pen" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=900 --grid-size=1  --quantization-bits=5  --category-part-indicator=True --context-window=400  --prefix-key-len=32 --prefix-value-len=32 --load-meta=True  # --debug=True   # --debug=True #  --apply-random-scaling=1 --apply-random-scaling=1 
