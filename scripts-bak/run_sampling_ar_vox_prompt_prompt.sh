...
#### vox prompt ####
# grid size; quantization bits...
# CUDA_VISIBLE_DEVICES=0 python trainer/sampling_ar_vox_prompt_prompt.py  --exp-mode="sampling"  --max-permit-vertices=800 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_v9_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=800 --max-faces=3000 --batch-size=1  --check-step=200 --exp-flag="parts_v9_frames_pr_v3" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=1  --quantization-bits=6 --vertex-model-path="/nas/datasets/gen/ckpts/finetuning_ar_vox_prompt_parts_v9_frames_pr_v3_indi_True_ctx_400_gs_800_scale_0_MotionDataset_processed_voxelized_64_v9_ns_50_bsz_1_max_verts_800_max_permit_verts_800_key_len_512/vertex_model/20800.pth" --encoder-adapter-path="/nas/datasets/gen/ckpts/finetuning_ar_vox_prompt_parts_v9_frames_pr_v3_indi_True_ctx_400_gs_800_scale_0_MotionDataset_processed_voxelized_64_v9_ns_50_bsz_1_max_verts_800_max_permit_verts_800_key_len_512/adapter_modules/20800.pth" --prefix-key-len=512 --prefix-value-len=512 --context-window=400  --category-part-indicator=True --nn-training-categories=9 --load-meta=True --sample-class-idx=0 # --debug=True   # --debug=True #  --apply-random-scaling=1 --context-window=900
...
#### vox prompt ####
# grid size; quantization bits...
CUDA_VISIBLE_DEVICES=1 python trainer/sampling_ar_vox_prompt_prompt.py  --exp-mode="sampling"  --max-permit-vertices=800 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_v9_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=800 --max-faces=3000 --batch-size=1  --check-step=200 --exp-flag="parts_v9_closestool_pr_v4" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=1  --quantization-bits=6 --vertex-model-path="/nas/datasets/gen/ckpts/finetuning_ar_vox_prompt_parts_v9_frames_pr_v4_indi_True_ctx_300_gs_800_scale_0_MotionDataset_processed_voxelized_64_ns_50_bsz_1_max_verts_800_max_permit_verts_800_key_len_512/vertex_model/22000.pth" --encoder-adapter-path="/nas/datasets/gen/ckpts/finetuning_ar_vox_prompt_parts_v9_frames_pr_v4_indi_True_ctx_300_gs_800_scale_0_MotionDataset_processed_voxelized_64_ns_50_bsz_1_max_verts_800_max_permit_verts_800_key_len_512/adapter_modules/22000.pth" --prefix-key-len=512 --prefix-value-len=512 --context-window=300  --category-part-indicator=True --nn-training-categories=9 --load-meta=True --sample-class-idx=3 # --debug=True   # --debug=True #  --apply-random-scaling=1 --context-window=900
