...
# for sampling_idx in 0
# do
#   CUDA_VISIBLE_DEVICES=1 python trainer/sampling_ar_vox_prompt.py  --exp-mode="sampling"  --max-permit-vertices=800 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_v9_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=800 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="parts_legs_noinst" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=800 --grid-size=1  --quantization-bits=6  --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_vox_prompt_parts_legs_noinst_indi_True_ctx_400_gs_800_scale_0_MotionDataset_processed_voxelized_32_v9_ns_50_bsz_1_max_verts_800_max_permit_verts_800_key_len_512/vertex_model/58000.pth"   --prefix-key-len=512 --prefix-value-len=512 --load-meta=True --sample-class-idx=${sampling_idx} --category-part-indicator=True --training-steps=20 --context-window=400   # --debug=True   # --debug=True #  --apply-random-scaling=1  # load-meta
# done

for sampling_idx in 0
do
  CUDA_VISIBLE_DEVICES=2 python trainer/sampling_ar_vox_prompt.py  --exp-mode="sampling"  --max-permit-vertices=650 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64_ns_50" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=650 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="parts_v9_uncond" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --max-num-grids=650 --grid-size=1  --quantization-bits=6  --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_vox_prompt_parts_v9_6n_indi_False_ctx_300_gs_650_scale_0_MotionDataset_processed_voxelized_64_ns_50_bsz_1_max_verts_650_max_permit_verts_650_key_len_512/vertex_model/102000.pth"   --prefix-key-len=512 --prefix-value-len=512 --load-meta=True --sample-class-idx=${sampling_idx}  --training-steps=20 --context-window=300   # --debug=True   # --debug=True #  --apply-random-scaling=1  # load-meta --category-part-indicator=True
done
# /nas/datasets/gen/ckpts/pretraining_ar_vox_prompt_parts_v9_6n_indi_False_ctx_300_gs_800_scale_0_MotionDataset_processed_voxelized_64_ns_50_bsz_1_max_verts_800_max_permit_verts_800_key_len_512/vertex_model/20000.pth
...
# /nas/datasets/gen/ckpts/pretraining_ar_vox_prompt_parts_legs_inst_indi_True_ctx_-1_gs_800_scale_0_MotionDataset_processed_voxelized_64_v9_ns_50_bsz_1_max_verts_800_max_permit_verts_800_key_len_512/vertex_model/24000.pth.
