...
CUDA_VISIBLE_DEVICES=4 python trainer/sampling_ar_prompt.py  --exp-mode="sampling"  --max-permit-vertices=400 --max-permit-faces=2000 --dataset-name="MotionDataset_processed_deci_part_first_30_normalized" --category="eyeglasses" --recenter-mesh=True  --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=400 --max-faces=2000 --batch-size=2  --check-step=200  --vertex-model-path="/nas/datasets/gen/ckpts/finetuning_ar_prompt_prompt_ft_fr_512_ctx_600_cat_part_indi_True_face_cond_False_light_False_shift_False_scale_0_MotionDataset_processed_voxelized_part_first_bsz_1_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/vertex_model/166000.pth" --face-model-path="/nas/datasets/gen/ckpts/finetuning_ar_prompt_prompt_ft_fr_512_ctx_600_cat_part_indi_True_face_cond_False_light_False_shift_False_scale_0_MotionDataset_processed_voxelized_part_first_bsz_1_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/face_model/166000.pth"  --encoder-adapter-path="/nas/datasets/gen/ckpts/finetuning_ar_prompt_prompt_ft_fr_512_ctx_600_cat_part_indi_True_face_cond_False_light_False_shift_False_scale_0_MotionDataset_processed_voxelized_part_first_bsz_1_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/encoder_adapter/166000.pth" --decoder-adapter-face-path="/nas/datasets/gen/ckpts/finetuning_ar_prompt_prompt_ft_fr_512_ctx_600_cat_part_indi_True_face_cond_False_light_False_shift_False_scale_0_MotionDataset_processed_voxelized_part_first_bsz_1_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/decoder_adapter_face/166000.pth" --decoder-adapter-vertex-path="/nas/datasets/gen/ckpts/finetuning_ar_prompt_prompt_ft_fr_512_ctx_600_cat_part_indi_True_face_cond_False_light_False_shift_False_scale_0_MotionDataset_processed_voxelized_part_first_bsz_1_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/decoder_adapter_vertex/166000.pth" --exp-flag="prompt_fr_eye" --num-classes=120 --category-part-indicator=True  --prefix-key-len=512 --prefix-value-len=512  --context-window=600
