...
# 
# # ### small model ###
# CUDA_VISIBLE_DEVICES=2 python trainer/pretraining_ml.py  --exp-mode="pretraining"  --max-permit-vertices=400 --max-permit-faces=2000 --dataset-name="MotionDataset_processed_deci_part_first_30_normalized_reform" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=400 --max-faces=2000 --batch-size=2  --check-step=2000 --exp-flag="some_parts_v0_ml_0.50" --num-classes=120 --nn-vertices-predict-ratio=1.0    --category-part-indicator=True  --mask-low-ratio=0.50 --mask-high-ratio=0.50   --not-remove-du=True  # --debug=True

# ### small model ###
CUDA_VISIBLE_DEVICES=2 python trainer/pretraining_ml.py  --exp-mode="pretraining"  --max-permit-vertices=400 --max-permit-faces=2000 --dataset-name="MotionDataset_processed_voxelized_part_first" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=400 --max-faces=2000 --batch-size=2  --check-step=2000 --exp-flag="v0_ml_0.50_val" --num-classes=120 --nn-vertices-predict-ratio=1.0    --category-part-indicator=True  --mask-low-ratio=0.50 --mask-high-ratio=0.51   --not-remove-du=True #  --debug=True
