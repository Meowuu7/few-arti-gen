...
# export DATASET_NAME="MotionDataset_processed" # /nas/datasets/gen/datasets/PartNet
# export DATASET_NAME="MotionDataset_processed_deci_part_first_0.2_normalized"
...
export SUBDN=3 # 4, 3
export CONTEXT_WINDOW=2410 # 500 # 350 # 400 #500
export MAX_NUM_GRIDS=2410 # 500 # 400 # 800 # 400 #500
# export EXP_FLAG="bulk_ft" # "ctx_500_subd5"
export EXP_FLAG="bulk_scra_wf_subd_1" # "ctx_500_subd5"
export AR_SUBD_IDX=1 # 2 ### subdidx
