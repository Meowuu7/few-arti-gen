...
# CUDA_VISIBLE_DEVICES=2 python trainer/finetuning_ar.py  --exp-mode="finetuning"  --max-permit-vertices=400 --max-permit-faces=2000 --dataset-name="MotionDataset_processed_deci_part_first_30" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=400 --max-faces=2000 --batch-size=16  --check-step=200 --exp-flag="some_parts_v4" --num-classes=177 --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_some_parts_v3_cat_part_indi_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_30_bsz_16_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/vertex_model/82600.pth" --face-model-path="/nas/datasets/gen/ckpts/pretraining_ar_some_parts_v3_cat_part_indi_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_30_bsz_16_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/face_model/82600.pth" --use-light-weight=True  --debug=True 
...
#### larger model finetuning ####
CUDA_VISIBLE_DEVICES=5 python trainer/finetuning_ar_adapter.py  --exp-mode="finetuning"  --max-permit-vertices=400 --max-permit-faces=2000 --dataset-name="MotionDataset_processed_deci_part_first_30_normalized" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=400 --max-faces=2000 --batch-size=2  --check-step=200 --exp-flag="finetune_frames_adapter" --num-classes=120 --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_some_parts_v1_cat_part_indi_False_face_cond_False_light_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_30_normalized_bsz_2_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/vertex_model/36400.pth" --face-model-path="/nas/datasets/gen/ckpts/pretraining_ar_some_parts_v1_cat_part_indi_False_face_cond_False_light_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_30_normalized_bsz_2_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/face_model/36400.pth" 
#  --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_some_parts_v1_cat_part_indi_False_face_cond_False_light_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_30_bsz_2_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/vertex_model/110400.pth" --face-model-path="/nas/datasets/gen/ckpts/pretraining_ar_some_parts_v1_cat_part_indi_False_face_cond_False_light_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_30_bsz_2_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/face_model/110400.pth"  # debug=True
# --debug=True --category-part-indicator=True --use-light-weight=True 
# --num-classes=177 --category-part-indicator=True # --debug=True
# --debug=Trues
# --cus-perm-xl=True # --cross=True # --debug=True 
