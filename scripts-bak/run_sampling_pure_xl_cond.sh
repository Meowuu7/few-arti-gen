...
CUDA_VISIBLE_DEVICES=1 python trainer/sampling_xl_cond.py  --exp-mode="sampling" --use-light-weight=True  --max-permit-vertices=400 --max-permit-faces=2000 --dataset-name="MotionDataset_processed_deci_scaled" --category="eyeglasses" --recenter-mesh=True --apply-random-shift=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=400 --max-faces=2000 --batch-size=16  --mask-low-ratio=0.30 --mask-high-ratio=0.50  --check-step=200  --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_pure_xl_cond__tot_cus_False_cross_False_4_MotionDataset_processed_deci_scaled_cat_eyeglasses_bsz_16_max_verts_400_faces_2000_max_permit_verts_400_faces_2000_mask_low_0.3_high_0.5/vertex_model/132200.pth" --face-model-path="/nas/datasets/gen/ckpts/pretraining_pure_xl_cond__tot_cus_False_cross_False_4_MotionDataset_processed_deci_scaled_cat_eyeglasses_bsz_16_max_verts_400_faces_2000_max_permit_verts_400_faces_2000_mask_low_0.3_high_0.5/face_model/132200.pth" --pc-encoder-model-path="/nas/datasets/gen/ckpts/pretraining_pure_xl_cond__tot_cus_False_cross_False_4_MotionDataset_processed_deci_scaled_cat_eyeglasses_bsz_16_max_verts_400_faces_2000_max_permit_verts_400_faces_2000_mask_low_0.3_high_0.5/pc_encoder_cond_model/132200.pth" --exp-flag="interp_scaled_high_half_frame"
