...
CUDA_VISIBLE_DEVICES=3 python trainer/finetuning_1_xl.py  --use-light-weight=True  --max-permit-vertices=400 --max-permit-faces=2000 --dataset-name="MotionDataset_processed_deci_scaled_Sampled" --category="eyeglasses" --recenter-mesh=True --apply-random-shift=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=400 --max-faces=2000 --batch-size=16  --mask-low-ratio=0.30 --mask-high-ratio=0.50  --check-step=200 --cus-perm-xl=True --cross=True --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_tot_nostop_xl_cus_True_cross_True_4_MotionDataset_processed_deci_scaled_cat_oven_bsz_16_max_verts_400_faces_2000_max_permit_verts_400_faces_2000_mask_low_0.3_high_0.5/vertex_model/23400.pth" --face-model-path="/nas/datasets/gen/ckpts/pretraining_tot_nostop_xl_cus_True_cross_True_4_MotionDataset_processed_deci_scaled_cat_oven_bsz_16_max_verts_400_faces_2000_max_permit_verts_400_faces_2000_mask_low_0.3_high_0.5/face_model/23400.pth"
# --debug=True 
# ### tabel, PolyGen Samples ####
