...
export VERTEX_MODEL_PATH="/nas/datasets/gen/ckpts/pretraining_ar_grid_vocab_lamp_pen_delta_for_transfer_indi_True_ctx_1000_gs_2_ngrids_1000_nobj_3_scale_0_subd_mesh_bsz_1_max_verts_6500_max_permit_verts_6500_key_256/vertex_model/120400.pth"
# export VERTEX_MODEL_PATH=""
# export SUBDN=5 # 4, 3
export SUBDN=4 # 3 # 4 # , 3
...
export EXP_FLAG="lamp_delta_for_transfer" # "lamp_delta_for_transfer_0.1_ft_eye" # "ctx_500_subd5" ### test half_flaps
export EXP_FLAG="lamp_pen_delta_for_transfer"
export EXP_FLAG="lamp_pen_delta_for_transfer_0.1_ft_eye"
