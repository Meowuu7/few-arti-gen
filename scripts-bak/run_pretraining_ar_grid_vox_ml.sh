...
##### binvox pretraining mask modeling #####
# CUDA_VISIBLE_DEVICES=2 python trainer/pretraining_ar_grid_vox_ml.py  --exp-mode="pretraining"  --max-permit-vertices=1100 --max-permit-faces=3000 --dataset-name="MotionDataset_processed_voxelized_64" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=1100 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="v0_vox_ml_0.7" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --quantization-bits=6   --category-part-indicator=True --mask-low-ratio=0.70 --mask-high-ratio=0.71 # --debug=True   # --debug=True
##### binvox pretraining mask modeling #####
...
CUDA_VISIBLE_DEVICES=1 python trainer/pretraining_ar_grid_vox_ml.py  --exp-mode="pretraining"  --max-permit-vertices=1100 --max-permit-faces=3000 --dataset-name="MotionDataset_processed" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=1100 --max-faces=3000 --batch-size=1  --check-step=2000 --exp-flag="v0_vox_ml_0.15" --num-classes=120 --nn-vertices-predict-ratio=1.0  --not-remove-du=True --quantization-bits=6   --category-part-indicator=True --mask-low-ratio=0.15 --mask-high-ratio=0.16 --data-type='mesh' # --debug=True   # --debug=True
