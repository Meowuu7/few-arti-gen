...
CUDA_VISIBLE_DEVICES=6 python trainer/finetuning_ar.py  --exp-mode="finetuning"  --max-permit-vertices=400 --max-permit-faces=2000 --dataset-name="MotionDataset_processed_deci_part_first_30" --category="eyeglasses" --recenter-mesh=True --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=400 --max-faces=2000 --batch-size=2  --check-step=200 --exp-flag="no_finetune_oven" --num-classes=120 

# --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_some_parts_v1_cat_part_indi_False_face_cond_False_light_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_30_normalized_bsz_2_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/vertex_model/34800.pth" --face-model-path="/nas/datasets/gen/ckpts/pretraining_ar_some_parts_v1_cat_part_indi_False_face_cond_False_light_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_30_normalized_bsz_2_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/face_model/34800.pth" 
