...
CUDA_VISIBLE_DEVICES=3 python trainer/sampling_ar_two_parts.py  --exp-mode="sampling" --use-light-weight=True  --max-permit-vertices=400 --max-permit-faces=2000 --dataset-name="MotionDataset_processed_deci_part_first_30" --category="eyeglasses" --recenter-mesh=True  --dataset-root-path='/nas/datasets/gen/datasets' --max-vertices=400 --max-faces=2000 --batch-size=16  --check-step=200  --vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_two_parts_leg_to_frames_cat_part_indi_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_bsz_10_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/vertex_model/18000.pth" --face-model-path="/nas/datasets/gen/ckpts/pretraining_ar_two_parts_leg_to_frames_cat_part_indi_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_bsz_10_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/face_model/18000.pth" --fine-vertex-model-path="/nas/datasets/gen/ckpts/pretraining_ar_two_parts_leg_to_frames_cat_part_indi_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_bsz_10_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/fine_vertex_model/18000.pth" --fine-face-model-path="/nas/datasets/gen/ckpts/pretraining_ar_two_parts_leg_to_frames_cat_part_indi_False_shift_False_filp_False_MotionDataset_processed_deci_part_first_bsz_10_max_verts_400_faces_2000_max_permit_verts_400_faces_2000/fine_face_model/18000.pth" --exp-flag="leg_to_frame" --num-classes=7 --sample-class-idx=0
