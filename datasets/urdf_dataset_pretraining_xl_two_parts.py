...
class URDFDataset(data.Dataset):
          ...
          for cur_cat_nm in category_name:
            ...
            for cur_cat_cur_part_nm in part_nm_to_mesh_dict_idxes:
              ...
              for iii in part_nm_to_mesh_dict_idxes[cur_cat_cur_part_nm]:
                ...
                mesh_dict_idx_to_category_name[iii + cur_mesh_dict_len] = f"{cur_cat_nm}-{cur_cat_cur_part_nm}" # the category-part indicator
    ...
    def __getitem__(self, item):
        ...
        rt_dict = {
            ...
            'vertices_flat_mask_rgt': vertices_flat_mask_other,
            ...
            'num_vertices_lft': nn_vertices_lft,
