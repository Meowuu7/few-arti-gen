    ...
    def __init__(self, root_folder, quantization_bits=8, nn_max_vertices=8900, nn_max_faces=8900, nn_max_permite_vertices=400, nn_max_permite_faces=2000, category_name="eyeglasses", instance_nns=[], part_names=None, category_nm_to_part_nm=None, is_training=False
        ...
        #   mesh_dicts, part_tree = dataset_utils.get_mesh_dict_list_multi_part(self.root_folder, part_names=["none_motion"], valid_indices=self.instance_nns)
          ...
          for cur_cat_nm in category_name:
            ...
            cur_cat_mesh_dicts, part_tree = dataset_utils.get_mesh_dict_list_multi_part_part_first(cur_root_folder, part_names=part_names, valid_indices=self.instance_nns if cur_cat_nm == "eyeglasses" else None, category_name=cur_cat_nm)
