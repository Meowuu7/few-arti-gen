...
def attention_mask_single_direction(x, other_len=None): # mask single direction
    if other_len is None:
        x_other_dir = torch.zeros_like(x) #### x_other_dir: bsz x seq_length x 1 xxxxx bsz x 1 x seq_length
    else: 
