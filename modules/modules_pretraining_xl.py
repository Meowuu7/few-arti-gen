...
class VertexModel(nn.Module): # vertex model part?
    ...
    def forward(self, batch):
        ...
        pred_dist, outputs = self._create_dist(batch['vertices_flat'], batch['vertices_flat_mask'], batch['vertices_permutation'],  embedding_layers=self.inputs_embedding_layers, project_to_logits_layer=self.project_to_logits, global_context_embedding=global_context, sequential_context_embeddings=seq_context)
