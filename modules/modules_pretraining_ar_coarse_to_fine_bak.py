...
class VertexModel(nn.Module): # vertex model part?
    ...
    def _create_dist(self, vertices, embedding_layers, project_to_logits_layer, global_context_embedding=None, sequential_context_embeddings=None, temperature=1., top_k=0, top_p=1.0):
        # todo: cache!
    ...
    def _sample_vertices(self, num_samples, inputs_embedding_layers, project_to_logits, context_feature, seq_context, top_k, top_p): # sample
        loop_idx = 0
        # init samples
