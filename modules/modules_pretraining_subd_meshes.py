...
class VertexModel(nn.Module):
    ...
    def _embed_pts(self, cur_subd_prefix_pts, embedding_layers, context_content_indicator_embedding_layers, context_content_indicator=0):
        ...
        cur_subd_upsample_vert_embedding = cur_subd_upsample_vert_embedding[:, :, 0] + cur_subd_upsample_vert_embedding[:, :, 1] + cur_subd_upsample_vert_embedding[:, :, 2]
        ...
        cur_subd_upsample_vert_embedding = cur_subd_upsample_vert_embedding + verts_order_embedding
    ...
    #   print(f"i_subd_for_embedding: {i_subd_for_embedding}")
      for i_subd in i_subd_for_embedding: ###### subdn_to_embeddings
        ...
        cur_subd_upsample_vert_embedding = cur_subd_upsample_vert_embedding
    ...
    #   prefix_length = cur_subd_prefix_pts_nn + self.prefix_key_len
      ...
      for i_subd in subd_to_verts_embedding:
        ...
        grid_coord_outputs = grid_coord_outputs
        ...
        logits_x = cur_project_to_logits_layers[0](grid_coord_outputs)
        ...
        mu_xyz = logits_x[:, :, :3]
        sigma_xyz = torch.exp(logits_x[:, :, 3: 6])
