...
class VertexModel(nn.Module):
    ...
    def _prepare_context(self, context, adapter_modules=None):
        if self.class_conditional:
            if adapter_modules is None:
                global_context_embedding = self.class_embedding_layer(context['class_label']) # bsz x 1 x embedding_dim
                ...
                global_context_embedding = adapter_modules.prompt_values[0]
                global_context_embedding_content = adapter_modules.prompt_values[1]
                global_context_embedding_grid = adapter_modules.prompt_values[2]
    ...
    def _create_dist_grid_coord_v2(self, grid_order_coord_xyz_embeddings,  temperature=1., top_k=0, top_p=1.0): # prefix_key_length
