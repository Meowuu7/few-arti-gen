...
class VertexModel(nn.Module):
    ...
    def _create_dist_grid_coord_v2(self, grid_order_coord_xyz_embeddings,  temperature=1., top_k=0, top_p=1.0, rt_logits=False):
    #   bsz, grid_length = grid_order_embedding.size(0), grid_order_coord_xyz_embeddings.size(1) - 1
      ...
      if rt_logits:
        return cat_dist_grid_xyz, logits_xyz
      else:
