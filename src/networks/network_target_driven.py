...
class model(nn.Module):
    def __init__(self, num_basis):
        ...
        self.tar_conv11 = torch.nn.Conv1d(2883, 128, 1)
        self.tar_conv12 = torch.nn.Conv1d(128, 64, 1)
        self.tar_conv13 = torch.nn.Conv1d(64, 64, 1)
        self.tar_bn11 = nn.BatchNorm1d(128)
        self.tar_bn12 = nn.BatchNorm1d(64)
        self.tar_bn13 = nn.BatchNorm1d(64)
