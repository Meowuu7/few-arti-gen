...
def revoluteTransform(points, pivotPoint, axis, theta):
    ...
    try:
        a = pivotPoint[0]; b = pivotPoint[1]; c = pivotPoint[2]
    except:
        a = pivotPoint[0][0]; b = pivotPoint[0][1]; c = pivotPoint[0][2]
    
    try:
        u = axis[0]; v = axis[1]; w = axis[2]
    except:
        u = axis[0][0]; v = axis[0][1]; w = axis[0][2]
    ...
    points = np.dot(points, m) ## n_pts x 3 xxxx 3 x 4 --> n_pts x 3
    return points, m