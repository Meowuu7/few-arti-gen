...
def get_model_descriptor():
    ...
    model_descriptor = f"{exp_mode}_ar_prompt_{exp_flag}_fr_{use_eyeglasses_frame}_indi_{category_part_cat}_ctx_{context_window}_gs_{max_num_grids}_vpred_{nn_vertices_predict_ratio}_scale_{random_scaling}_{motion_dataset_nm}_bsz_{batch_size}_max_verts_{nn_max_vertices}_max_permit_verts_{nn_max_permite_vertices}"
