...
if __name__=='__main__':
    ...
    ##### whether to use encoder for prompt encoding #####
    with_prompt_enocder = opt.model.with_prompt_enocder
    vertex_module_config['with_prompt_enocder'] = with_prompt_enocder
    ##### whether to use encoder for prompt encoding #####
