...
if __name__=='__main__':
    ...
    adapter_module_config_encoder, adapter_module_config_decoder_vertex, adapter_module_config_decoder_face = get_adapter_config()

    encoder_adapter = AdapterTuning(**adapter_module_config_encoder)
    decoder_adapter_vertex = AdapterTuning(**adapter_module_config_decoder_vertex)
    decoder_adapter_face = AdapterTuning(**adapter_module_config_decoder_face)
