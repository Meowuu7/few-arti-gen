...
# from datasets.urdf_dataset_pretraining_xl import URDFDataset as URDFDataset_xl
from datasets.urdf_dataset_pretraining_ar_grid import URDFDataset as URDFDataset_ar
...
def step_sample(test_dataset, vertex_model, test_dataset_iter, cur_iter=0): # sample step
...
if __name__=='__main__':
    ...
    # test_iter(test_dataset, vertex_model, training_steps, batch_size):
