...
if __name__=='__main__':
    ...
    batch_size = opt.loss.batch_size
    # num_thread = 10 # set number of workers for data loaders
    num_thread = opt.dataset.num_workers
    ...
    #   category_names = category_name
      ...
      # category_name = ['globe', 'valve', 'handcart', 'screwdriver', 'window', 'swiss_army_knife', 'kettle', 'wine_bottle', 'cabinet', 'bucket']
      category_name = ["screwdriver", "eyeglasses",  "pen", "scissors", "stapler",]

      category_names_to_part_names = {
        k: None for k in category_name
      }
      category_names = list(category_names_to_part_names.keys())
    ...
    dataset_test_category_part_indicator_to_idxes = dataset_train_category_part_indicator_to_idxes
    ...
    if len(vertex_model_path) > 0: # load vertex model
        resume_from_ckpts(vertex_model, vertex_model_path)

    vertex_model_nparams = calculate_model_nparams(vertex_model)
    ...
    ### save dataset train related information ### # sv_ckpts_folder
