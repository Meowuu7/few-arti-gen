...
if __name__=='__main__':
    ...
    #   category_name = ["screwdriver", "eyeglasses",  "pen", "scissors", "stapler",]
      category_name = ["summary"]  #  ["subd0"]
      category_name = os.listdir(data_root_path)
