...
def get_model_descriptor():
    ...
    sample_class_idx = opt.model.sample_class_idx
    model_descriptor = f"{exp_mode}_ar_vox_{exp_flag}_indi_{category_part_cat}_ctx_{context_window}_gs_{max_num_grids}_class_{sample_class_idx}_scale_{random_scaling}_{motion_dataset_nm}_bsz_{batch_size}_max_verts_{nn_max_vertices}_max_permit_verts_{nn_max_permite_vertices}"
...
if __name__=='__main__':
    ...
    #### make samples folder and checkpoints folder ####
